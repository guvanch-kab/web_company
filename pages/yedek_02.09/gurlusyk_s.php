...
$(".sebede_gosh").removeClass('disabled').removeAttr('disabled').css({
    ...
    function updatePrice() {
        ...
        $(".price_item").html(`<h4><strong> ${(quantity * single_price).toFixed(2)} m </strong></h4>`);
    }
}
</script>
...
$(document).ready(function () {
   ...
   <div class="mb-2 product_cart2" style="width: 100%; box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px; display: flex;">
      <div class="col-md-6 singleImgcCont" style="border-right: 1px solid #efefde; background-color:#fff; display: flex;">
        
         <img src="" style="width:auto; height:auto; box-shadow: none;" class="img-fluid custom_direction"> 
      ...
      <div class="col-md-6 p-4" style=" background-color: #fff;">
         ...
         <div  style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="display:flex;border-radius: 3px;align-items: center;">
               <button id="decrease" style=" padding:4px;display: flex; align-items: center; justify-content: center; font-size: 15px; border: none; background-color: #007bff; color: #fff; border-right: 1px solid #ffffec; font-weight: 600; border-radius: 3px 0 0 3px;">-</button>
               <input type="text" class="item_quantity" id="" value="1" min="1" style="padding:5px; width:2rem; font-size: 14px;text-align: center; border: none; background-color: #007bff; color: #fff; outline: none;">
               <button id="increase" style="padding:4px; font-size: 15px; border: none; background-color: #007bff; color: #fff; border-left: 1px solid #ffffec; font-weight: 600; border-radius: 0 3px 3px 0; display: flex; align-items: center; justify-content: center;">+</button>
            </div>
            <div class="">
               <a href="#userExit" class="btn_shop_svg sebede_gosh bg-primary" style="padding:10px; border-radius:3px;">
						  ...
						  <div class="card-body"  style="padding:0 !important; align:left;">
							 ...
							 <div class="saga_yasla">
								...
								<a href="#" class="btn_shop_svg sebede_gosh bg-primary">
                                    <svg fill="#fff" height="24px" width="24px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 487.1 487.1" xml:space="preserve">
