...
function ekle() {    
    ...
    $(".single_title").off("click").on("click", function() {
       // $("#select_owl").hide()
        ...
        if(stock_amount==1){
            $(".stock_no").hide()
            $(".stock_have, .single_sebet").show()
        }
    else if(stock_amount==0){
    $(".stock_have, .single_sebet").hide()
    $(".stock_no").show()
...
$(document).ready(function () {
   ...
   <div class="col-md-6 singleImgCont" style="border-right: 1px solid #efefde; background-color: #fff; display: flex; flex-direction: column; width:100%; ">
      <img src="" alt="" style="width:90%; height: auto; box-shadow: none;" class="img-fluid custom_direction">
    ...
    <button id="increase" 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" fill="#007bff" class="icon-increase">
            <path d="M10 6L16 12L10 18Z" />
               ...
               <a href="#userExit" style="padding: 20px 25px;"  class="btn_shop_svg sebede_gosh single_sebet bg-primary">
...
<div class="container " id="tab_panels" style="padding: 0; display:flex;align-items:start;" >
   
<div class="harakter_side">
                       <div class="tab" style="background-color: #d8e880; margin-top:5px">
                          <button class="tablinks" onclick="openTab(event, 'Overview')">Overview</button>
                          <button class="tablinks" onclick="openTab(event, 'Harakteristiklar')">Harakteristiklar</button>
                          <button class="tablinks" onclick="openTab(event, 'Reviews')">Reviews</button>
                       </div>
                       <div id="Overview" class="tabcontent">
                          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quidem at fugiat libero non mollitia sequi laudantium eaque architecto, commodi obcaecati rem quae labore minus nemo ratione ea dolor, voluptates veniam?</p>
                       </div>
                       <div id="Harakteristiklar" class="tabcontent">
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam inventore adipisci tenetur optio, commodi tempore quis. Quisquam voluptate qui in adipisci nostrum, suscipit officiis dicta porro perspiciatis nam, ipsam exercitationem.</p>
                       </div>
                       <div id="Reviews" class="tabcontent">
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, ex atque earum libero soluta asperiores minima voluptatibus iure deserunt aperiam dicta unde neque est totam itaque, et nulla expedita voluptas.</p>
                       </div>
                    </div>
                </div>
    ...
    if (isset($_POST['bolum'])) {
        ...
        if ($bolum != null) {
            ...
            if ($result2 && mysqli_num_rows($result2) > 0) { 
                echo '
                <div class="container" style="margin-top:20px; padding-right:0; padding-left:0; display:flex; justify-content:center;" id="boyaglar_page">               
...
<div class="container" style="display: block;  margin-bottom:2%;" id="order_table">
        <form id="orderForm" style="width:100%;">
            ...
            <div class=""  id="order_table_row" style="display:flex; width:100%;">
                ...
                <div class="col-md-4" id="order_form" style="padding-right: 10px; width:40%;margin-left:auto;">
                    <!------------------------------ form place------------------------->
