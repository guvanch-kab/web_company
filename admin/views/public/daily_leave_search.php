...
';
        	                      ...
        	                      <div class="row" id="show_info" style="display: none;">
        	                          ...
        	                          <div class="col-2 ozeldegisim" >
        	                              <label style="font-size: 12px;" for="input_other1">Gidiş senesi</label>
        	                              <input type="date" class="form-control" name="date_reason" id="sene" min="<?php echo date('Y-m-d'); ?>">
        	                          </div>

									  <div class="col-2 ozeldegisim" style="display: none;" id="show_one">
        	                              <label style="font-size: 12px;" for="input_other1">Geliş senei</label>
        	                              <input type="date" class="form-control" name="date_reason" id="sene_gelis" min="<?php echo date('Y-m-d'); ?>">
        	                          </div>
        	                              ...
        	                              $(".select_person").click(function() {										
											select_reason = $(this).find('input#select_reason').val(); // select reason type         								  
        	                                  ...
        	                                  if (x.style.display === 'none') {
											   ...
											   if(select_reason==2 || select_reason==3 || select_reason==4) {
												$("#show_one").show();
												$("#show_time1").hide();
												$("#show_time2").hide();
											  }
