...
if (isset($_POST['basy'])) {
    ...
    $check_query = "SELECT * FROM controlgate1 WHERE DateEntry BETWEEN '$basy' AND '$sonu'";
    $check = mysqli_query($connect, $check_query);
}
...
if ($netije->num_rows > 0 && mysqli_num_rows($check) > 0) {
    $k = 1;
    $person_id = array();
    $person_name = array();
    $date_time = array();
...
} elseif (mysqli_num_rows($check) === 0 && $k == 0) {

    $warning_message = '<div class="alert alert-warning" role="alert">
    <strong>Uns berin! </strong> Gozlenyan gun - sene tapylmady.
</div>';
}
$conn->close();
?>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row" style="display: flex;align-items:center; justify-content: space-between;">
                    ...
                    <div class="col-md-6 card-title">Giriş</div>
                    <div class="col-md-6" style="display: flex; justify-content: end;">
                        <input id="basy" type="date" class="form-control form-control-sm senetakvimi" style="margin-right: 6px;">
                        <input id="sonu" type="date" class="form-control form-control-sm senetakvimi">
                    </div>
                </div>
            </div>
